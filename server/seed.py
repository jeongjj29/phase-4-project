...
def seed_data():
    ...
    with app.app_context():
        ...
        items = [
            Item(name="Apples"),
            Item(name="Bananas", image_url=f"bananas.jpg"),
            Item(name="Cherries"),
            Item(name="Dates"),
            Item(name="Eggs", image_url=f"eggs.jpg"),
            Item(name="Fish"),
            Item(name="Grapes"),
            Item(name="Honey"),
            Item(name="Ice Cream", image_url=f"icecream.jpg"),
            Item(name="Juice"),
            Item(name="Cheese"),
            Item(name="Milk", image_url=f"milk.jpg"),
            Item(name="Nuts"),
            Item(name="Oranges"),
            Item(name="Pears"),
            ...
            Item(name="V8 Strawberry Banana", image_url=f"V8StrawberryBanana.jpg"),
            Item(name="Bread", image_url=f"bread.jpg"),
            Item(name="Chewy Gronola Bars", image_url=f"chewy_bars.jpg"),
            Item(name="Coffee", image_url=f"coffee.jpg"),
            Item(name="Herseys Chocolate", image_url=f"herseschocloatr.jpg"),
            Item(name="Sasage Dog", image_url=f"saesage_dog.jpg"),
            Item(name="Tomatoes", image_url=f"tomatos.jpg"),
            Item(name="Yogurt"),
            Item(name="Zucchini"),
            Item(name="Avocados"),
            Item(name="Cucumbers"),
